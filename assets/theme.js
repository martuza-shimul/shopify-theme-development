...
function next() {
	var slideEl = document.querySelector(
		".product-single__media-wrapper:not(.hide)"
	);
	if (
		slideEl.nextElementSibling.className.includes(
			"product-single__media-wrapper"
		)
	) {
		slideEl.classList.add("hide");
		slideEl.nextElementSibling.classList.remove("hide");
	}
}
function prev() {
	var slideEl = document.querySelector(
	...
	if (
		slideEl.previousElementSibling.className.includes(
			"product-single__media-wrapper"
		)
	) {
		slideEl.classList.add("hide");
		slideEl.previousElementSibling.classList.remove("hide");
	}
}

var slideEls = document.querySelectorAll(".product-single__media-wrapper");
